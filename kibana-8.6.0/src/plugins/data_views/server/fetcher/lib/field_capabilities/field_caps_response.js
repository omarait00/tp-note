...
function readFieldCapsResponse(fieldCapsResponse) {
  ...
  const kibanaFormattedCaps = Object.keys(capsByNameThenType).reduce((agg, fieldName) => {
    var _capsByType$types$0$m, _capsByType$types$0$m2;
    ...
    const field = {
      ...
      metadata_field: capsByType[types[0]].metadata_field,
      fixedInterval: (_capsByType$types$0$m = capsByType[types[0]].meta) === null || _capsByType$types$0$m === void 0 ? void 0 : _capsByType$types$0$m.fixed_interval,
      timeZone: (_capsByType$types$0$m2 = capsByType[types[0]].meta) === null || _capsByType$types$0$m2 === void 0 ? void 0 : _capsByType$types$0$m2.time_zone,
