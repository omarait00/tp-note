...
function getUiSettings(docLinks) {
  ...
  "to": "now"
      ...
      type: 'json',
      description: _i18n.i18n.translate('data.advancedSettings.timepicker.timeDefaultsDescription', {
        defaultMessage: 'The timefilter selection to use when Kibana is started without one. Must be an object containing "from" and "to" (see {acceptedFormatsLink}).',
        values: {
    ...
    [_common.UI_SETTINGS.AUTOCOMPLETE_VALUE_SUGGESTION_METHOD]: {
      ...
      description: _i18n.i18n.translate('data.advancedSettings.autocompleteValueSuggestionMethodText', {
        defaultMessage: 'The method used for querying suggestions for values in KQL autocomplete. Select terms_enum to use the ' + 'Elasticsearch terms enum API for improved autocomplete suggestion performance. (Note that terms_enum is ' + 'incompatible with Document Level Security.) Select terms_agg to use an Elasticsearch terms aggregation. ' + '{learnMoreLink}',
        values: {
