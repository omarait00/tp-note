...
const aggStdDeviation = () => ({
  ...
  args: {
    ...
    showBounds: {
      types: ['boolean'],
      default: true,
      help: _i18n.i18n.translate('data.search.aggs.metrics.std_deviation.showBounds.help', {
        defaultMessage: 'Specifies whether this aggregation should return upper and lower bound or the standard deviation itself'
      })
    },
    field: {
      types: ['string'],
