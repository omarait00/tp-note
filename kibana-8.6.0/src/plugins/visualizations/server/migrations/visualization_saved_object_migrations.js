    ...
    if (visState && visState.type === 'metrics' && searchSourceJSON !== '{}') {
      return {
        ...
        attributes: {
          ...doc.attributes,
          kibanaSavedObjectMeta: {
            ...(0, _lodash.get)(doc, 'attributes.kibanaSavedObjectMeta'),
            searchSourceJSON: '{}'
          }
        }
      };
...
const removeExclamationCircleIcon = doc => {
  const visStateJSON = (0, _lodash.get)(doc, 'attributes.visState');
  let visState;
  if (visStateJSON) {
    try {
    ...
    const newVisState = (0, _visualization_common_migrations.commonRemoveExclamationCircleIcon)(visState);
    return {
      ...doc,
      attributes: {
        ...doc.attributes,
