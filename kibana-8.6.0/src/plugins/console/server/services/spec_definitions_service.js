...
class SpecDefinitionsService {
  ...
  loadJSONSpecInDir(dirname) {
    const generatedFiles = _globby.default.sync((0, _path.join)(dirname, 'generated', '*.json'));
    const overrideFiles = _globby.default.sync((0, _path.join)(dirname, 'overrides', '*.json'));
