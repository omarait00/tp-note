...
class ElasticsearchService {
  ...
  setup({
    ...
    return {
      ...
      }), (0, _operators.takeWhile)(status => status !== _common.ElasticsearchConnectionStatus.Configured, /* inclusive */true), (0, _operators.distinctUntilChanged)(), (0, _operators.shareReplay)({
        refCount: true,
        bufferSize: 1
      })),
