...
function TooltipTableColorCell(_a) {
    var color = _a.color, className = _a.className, cellProps = __rest(_a, ["color", "className"]);
    ...
    return (react_1.default.createElement(tooltip_table_cell_1.TooltipTableCell, __assign({}, cellProps, { className: (0, classnames_1.default)('echTooltip__colorCell', className, {
        ...
        }) }), color ? (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("div", { className: "echTooltip__colorStripSpacer" }))) : null));
}
