...
var drawFrame = function (ctx, gl, cssWidth, cssHeight, minimapWidth, minimapHeight, minimapLeft, minimapTop, dpr, columnarGeomData, pickTexture, pickTextureRenderer, roundedRectRenderer, hoverIndex, unitRowHeight, currentColor, theme) {
    return function (currentFocus, wobbleIndex, wobble, nodeTweenTime) {
        ...
        var scrollbarThumb = theme.scrollbarThumb, scrollbarTrack = theme.scrollbarTrack;
        ...
        var drawContextLayer = function (pickLayer) {
            return (0, draw_webgl_1.drawWebgl)(gl, nodeTweenTime, minimapCanvasWidth, minimapCanvasHeight, minimapCanvasX, pickLayer ? 0 : minimapCanvasY, pickTexture, pickLayer ? pickTextureRenderer : roundedRectRenderer, hoverIndex, unitRowHeight, fullFocus, columnarGeomData.label.length, false, pickLayer, wobbleIndex, wobble);
        };
