...
var DUMMY_INDEX = -1;
var drawWebgl = function (gl, nodeTweenTime, canvasWidth, canvasHeight, xOffset, yOffset, pickTexture, renderer, hoverIndex, rowHeight, f, instanceCount, focusLayer, pickLayer, wobbleIndex, wobble) {
    return renderer({
