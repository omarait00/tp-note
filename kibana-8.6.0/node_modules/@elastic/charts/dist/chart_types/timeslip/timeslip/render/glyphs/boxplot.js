...
function renderBoxplotGlyph(ctx, barMaxWidthPixels, barX, leftShortfall, foundRow, maxBarHeight, yUnitScale, opacityMultiplier, r, g, b, maxOpacity) {
    ...
    var lowerY = maxBarHeight * yUnitScale(lower);
    var q1Y = maxBarHeight * yUnitScale(q1);
    var q2Y = maxBarHeight * yUnitScale(q2);
    var q3Y = maxBarHeight * yUnitScale(q3);
    var upperY = maxBarHeight * yUnitScale(upper);
