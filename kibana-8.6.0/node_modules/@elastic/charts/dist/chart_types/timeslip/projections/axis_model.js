...
var oneTwoFive = function (mantissa) { return (mantissa > 5 ? 10 : mantissa > 2 ? 5 : mantissa > 1 ? 2 : 1); };
exports.oneTwoFive = oneTwoFive;
var oneFive = function (mantissa) { return (mantissa > 5 ? 10 : mantissa > 1 ? 5 : 1); };
exports.oneFive = oneFive;
var getNiceTicksForApproxCount = function (domainMin, domainMax, approxDesiredTickCount, mantissaFun) {
    if (mantissaFun === void 0) { mantissaFun = exports.oneTwoFive; }
    ...
    var niceMantissa = mantissaFun(mantissa);
...
var getDecimalTicks = function (domainMin, domainMax, maximumTickCount, mantissaFun) {
    if (mantissaFun === void 0) { mantissaFun = exports.oneTwoFive; }
    var bestCandidate = [];
    for (var i = 0; i <= maximumTickCount; i++) {
        var candidate = getNiceTicksForApproxCount(domainMin, domainMax, maximumTickCount - i, mantissaFun);
...
var axisModel = function (domainLandmarks, desiredTickCount) {
    ...
    var niceTicks = (0, exports.getDecimalTicks)(domainMin, domainMax, desiredTickCount);
