...
const DEFAULT_ROLES = _node_config.NODE_ACCEPTED_ROLES;
...
class NodeService {
  ...
  async preboot({
    ...
    this.roles = _node_config.NODE_ACCEPTED_ROLES.reduce((acc, curr) => {
      return {
        ...acc,
        [(0, _lodash.camelCase)(curr)]: roles.includes(curr)
      };
    }, {});
    return {
      roles: this.roles
