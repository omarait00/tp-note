 ...
 * @internal
 */
function createPluginInitializerContext({
  coreContext,
  opaqueId,
  manifest,
  instanceInfo,
  ...
  return {
    ...
    config: {
       ...
       */
      create() {
        return coreContext.configService.atPath(manifest.configPath).pipe((0, _operators.shareReplay)(1));
      },
      get() {
        return coreContext.configService.atPathSync(manifest.configPath);
      }
    }
  };
}
