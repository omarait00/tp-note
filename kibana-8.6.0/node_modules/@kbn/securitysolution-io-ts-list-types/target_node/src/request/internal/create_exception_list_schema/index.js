...
const internalCreateExceptionListSchema = t.intersection([t.exact(t.type({
  ...
  list_id: t.keyof({
    [_securitysolutionListConstants.ENDPOINT_TRUSTED_APPS_LIST_ID]: null,
    [_securitysolutionListConstants.ENDPOINT_EVENT_FILTERS_LIST_ID]: null,
    [_securitysolutionListConstants.ENDPOINT_HOST_ISOLATION_EXCEPTIONS_LIST_ID]: null,
    [_securitysolutionListConstants.ENDPOINT_BLOCKLISTS_LIST_ID]: null
  })
