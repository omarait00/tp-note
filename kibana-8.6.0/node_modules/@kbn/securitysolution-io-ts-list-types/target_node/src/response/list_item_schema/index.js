...
exports.listItemSchema = exports.listItemArraySchema = void 0;
...
const listItemSchema = t.exact(t.type({
...
const listItemArraySchema = t.array(listItemSchema);
exports.listItemArraySchema = listItemArraySchema;