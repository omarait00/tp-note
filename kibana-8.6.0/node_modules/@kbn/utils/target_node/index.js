...
var _package_json = require("./src/package_json");
...
var _repo_root = require("./src/repo_root");
Object.keys(_repo_root).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _repo_root[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _repo_root[key];
    }
  });
});
