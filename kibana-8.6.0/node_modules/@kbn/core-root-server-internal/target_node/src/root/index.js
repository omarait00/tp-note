...
class Root {
  ...
  setupApmLabelSync() {
    ...
    this.apmConfigSubscription = configService.getConfig$().pipe((0, _operators.switchMap)(() => configService.atPath('elastic')), (0, _operators.distinctUntilChanged)(_lodash.isEqual), (0, _operators.tap)(elasticConfig => {
  ...
  async setupLogging() {
    ...
    (0, _operators.switchMap)(() => configService.atPath('logging')), (0, _operators.concatMap)(config => this.loggingSystem.upgrade(config)),
