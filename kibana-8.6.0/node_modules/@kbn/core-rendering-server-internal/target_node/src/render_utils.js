...
const getStylesheetPaths = ({
  ...
  return [...(darkMode ? [`${regularBundlePath}/kbn-ui-shared-deps-npm/${_uiSharedDepsNpm.default.darkCssDistFilename(themeVersion)}`, `${regularBundlePath}/kbn-ui-shared-deps-src/${UiSharedDepsSrc.cssDistFilename}`, `${basePath}/node_modules/@kbn/ui-framework/dist/kui_dark.min.css`, `${basePath}/ui/legacy_dark_theme.min.css`] : [`${regularBundlePath}/kbn-ui-shared-deps-npm/${_uiSharedDepsNpm.default.lightCssDistFilename(themeVersion)}`, `${regularBundlePath}/kbn-ui-shared-deps-src/${UiSharedDepsSrc.cssDistFilename}`, `${basePath}/node_modules/@kbn/ui-framework/dist/kui_light.min.css`, `${basePath}/ui/legacy_light_theme.min.css`])];
};
