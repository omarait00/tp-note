...
class OpsMetricsCollector {
  constructor(server, agentStore, opsOptions) {
    ...
    this.esClientCollector = new _coreMetricsCollectorsServerInternal.ElasticsearchClientsMetricsCollector(agentStore);
  }
  async collect() {
