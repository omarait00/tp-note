...
exports.updateTargetMappingsMeta = void 0;
 ...
 */
const updateTargetMappingsMeta = ({
  client,
  index,
  meta
}) => () => {
  return client.indices.putMapping({
    ...
    return Either.right('update_mappings_meta_succeeded');
  }).catch(_catch_retryable_es_client_errors.catchRetryableEsClientErrors);
};
exports.updateTargetMappingsMeta = updateTargetMappingsMeta;