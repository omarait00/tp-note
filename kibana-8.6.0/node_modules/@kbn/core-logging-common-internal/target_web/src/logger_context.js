 ...
 */
export var getLoggerContext = function getLoggerContext(contextParts) {
 ...
 */
export var getParentLoggerContext = function getParentLoggerContext(context) {
  var lastIndexOfSeparator = context.lastIndexOf(CONTEXT_SEPARATOR);
