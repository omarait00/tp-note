 ...
 */
const DefaultSeverityMappingArray = new t.Type('DefaultSeverityMappingArray', _severity_mapping.SeverityMapping.is, (input, context) => input == null ? t.success([]) : _severity_mapping.SeverityMapping.validate(input, context), t.identity);
