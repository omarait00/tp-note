...
class UiSettingsClient extends _base_ui_settings_client.BaseUiSettingsClient {
  ...
  async write({
    ...
    try {
      ...
      if (!_coreSavedObjectsUtilsServer.SavedObjectsErrorHelpers.isNotFoundError(error) || !autoCreateOrUpgradeIfMissing) {
        throw error;
      }
  ...
  isIgnorableError(error) {
    ...
    } = _coreSavedObjectsUtilsServer.SavedObjectsErrorHelpers;
