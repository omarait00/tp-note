...
exports.transformDefaultIndex = transformDefaultIndex;
 ...
 */
const transforms = [transformDefaultIndex];
...
async function transformDefaultIndex(params) {
  const {
    savedObjectsClient,
    configAttributes
  } = params;
  if (configAttributes !== null && configAttributes !== void 0 && configAttributes.isDefaultIndexMigrated) {
  ...
  if (!(configAttributes !== null && configAttributes !== void 0 && configAttributes.defaultIndex)) {
