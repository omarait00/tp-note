...
exports.UsageStatsClient = exports.RESOLVE_COPY_STATS_PREFIX = exports.DISABLE_LEGACY_URL_ALIASES_STATS_PREFIX = exports.COPY_STATS_PREFIX = void 0;
...
const DISABLE_LEGACY_URL_ALIASES_STATS_PREFIX = 'apiCalls.disableLegacyUrlAliases';
exports.DISABLE_LEGACY_URL_ALIASES_STATS_PREFIX = DISABLE_LEGACY_URL_ALIASES_STATS_PREFIX;
...
class UsageStatsClient {
  ...
  async incrementCopySavedObjects({
    ...
    const counterFieldNames = ['total', `kibanaRequest.${isKibanaRequest ? 'yes' : 'no'}`, `createNewCopiesEnabled.${createNewCopies ? 'yes' : 'no'}`, ...(!createNewCopies ? [`overwriteEnabled.${overwrite ? 'yes' : 'no'}`] : []) // the overwrite option is ignored when createNewCopies is true
    ];
  ...
  async incrementDisableLegacyUrlAliases() {
