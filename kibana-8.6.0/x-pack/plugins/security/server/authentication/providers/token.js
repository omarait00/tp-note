...
class TokenAuthenticationProvider extends _base.BaseAuthenticationProvider {
  ...
  async login(request, {
    ...
    try {
      ...
      return _authentication_result.AuthenticationResult.succeeded(this.authenticationInfoToAuthenticatedUser(
...
(0, _defineProperty2.default)(TokenAuthenticationProvider, "type", 'token');