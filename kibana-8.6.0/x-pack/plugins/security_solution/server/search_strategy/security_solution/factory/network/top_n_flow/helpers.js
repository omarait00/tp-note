...
const getGeoItem = result => result.location.top_geo.hits.hits.length > 0 && result.location.top_geo.hits.hits[0].fields ? {
  geo: (0, _format_response_object_values.formatResponseObjectValues)((0, _fp.getOr)('', `${Object.keys(result.location.top_geo.hits.hits[0].fields)[0].split('.geo')[0]}.geo`, (0, _format_response_object_values.unflattenObject)((0, _format_response_object_values.transformLocationFields)((0, _fp.getOr)({}, `location.top_geo.hits.hits[0].fields`, result))))),
  flowTarget: getFlowTargetFromString(Object.keys(result.location.top_geo.hits.hits[0].fields)[0].split('.geo')[0])
} : null;
