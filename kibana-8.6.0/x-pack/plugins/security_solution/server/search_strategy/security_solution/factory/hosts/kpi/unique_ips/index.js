...
const hostsKpiUniqueIps = {
  ...
  parse: async (options, response) => {
    ...
    return {
      ...
      uniqueSourceIpsHistogram: (0, _format_general_histogram_data.formatGeneralHistogramData)(uniqueSourceIpsHistogram),
      uniqueDestinationIps: (0, _fp.getOr)(null, 'aggregations.unique_destination_ips.value', response.rawResponse),
      uniqueDestinationIpsHistogram: (0, _format_general_histogram_data.formatGeneralHistogramData)(uniqueDestinationIpsHistogram)
    };
  }
};
