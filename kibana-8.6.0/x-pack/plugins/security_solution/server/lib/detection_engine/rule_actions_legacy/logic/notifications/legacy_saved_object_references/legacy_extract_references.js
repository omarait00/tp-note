...
exports.legacyExtractReferences = void 0;
var _legacy_extract_rule_id = require("./legacy_extract_rule_id");
/*
 ...
 */
const legacyExtractReferences = ({
  logger,
  params
}) => {
  const legacyRuleIdReferences = (0, _legacy_extract_rule_id.legacyExtractRuleId)({
    logger,
...
exports.legacyExtractReferences = legacyExtractReferences;