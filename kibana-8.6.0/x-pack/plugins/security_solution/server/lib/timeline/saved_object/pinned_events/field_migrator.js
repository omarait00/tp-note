...
exports.pinnedEventFieldsMigrator = void 0;
 ...
 * object.
 */
const pinnedEventFieldsMigrator = new _migrator.FieldMigrator([{
  path: 'timelineId',
  type: _saved_object_mappings.timelineSavedObjectType,
  name: _constants.TIMELINE_ID_REF_NAME
}]);
exports.pinnedEventFieldsMigrator = pinnedEventFieldsMigrator;