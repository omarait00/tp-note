...
exports.timelineSavedObjectOmittedFields = exports.setTimeline = exports.isImportRegular = exports.isBulkError = exports.importTimelines = void 0;
...
const importTimelines = async (file, maxTimelineImportExportSize, frameworkRequest, isImmutable) => {
  ...
  const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(importTimelinesRes, _timeline.importTimelineResultSchema);
