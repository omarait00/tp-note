...
var _get_metrics2 = require("./endpoint/get_metrics");
/*
...
const registerCollector = ({
  ...
  const collector = usageCollection.makeUsageCollector({
    ...
    schema: {
      ...
      endpointMetrics: {
        unique_endpoint_count: {
          type: 'long',
          _meta: {
            description: 'Number of active unique endpoints in last 24 hours'
          }
        }
      }
    },
    ...
    fetch: async ({
      ...
      const [detectionMetrics, endpointMetrics] = await Promise.allSettled([(0, _get_metrics.getDetectionsMetrics)({
        eventLogIndex,
        signalsIndex,
        esClient,
        savedObjectsClient,
        logger,
        mlClient: ml
      }), (0, _get_metrics2.getEndpointMetrics)({
        esClient,
        logger
      })]);
      return {
