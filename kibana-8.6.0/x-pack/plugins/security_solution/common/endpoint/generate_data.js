...
var _endpoint_metadata_generator = require("./data_generators/endpoint_metadata_generator");
 ...
 */
exports.categoryMapping = categoryMapping;
...
class EndpointDocGenerator extends _base_data_generator.BaseDataGenerator {
   ...
   */
  constructor(seed = Math.random().toString(), MetadataGenerator = _endpoint_metadata_generator.EndpointMetadataGenerator) {
    super(seed);
    (0, _defineProperty2.default)(this, "commonInfo", void 0);
    (0, _defineProperty2.default)(this, "sequence", 0);
    (0, _defineProperty2.default)(this, "metadataGenerator", void 0);
  ...
  generateEvent(options = {}) {
    var _options$ancestry$sli, _options$ancestry, _options$ancestryArra2, _options$eventsDataSt2;
