...
exports.validateTree = exports.validateEvents = exports.validateEntities = void 0;
...
const validateTree = {
  body: _configSchema.schema.object({
    ...
    includeHits: _configSchema.schema.boolean({
      defaultValue: false
    })
  })
};
...
const validateEvents = {
  ...
  body: _configSchema.schema.object({
    ...
    entityType: _configSchema.schema.maybe(_configSchema.schema.string()),
    eventID: _configSchema.schema.maybe(_configSchema.schema.string())
  })
};
