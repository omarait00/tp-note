...
var _register_post_route = require("./register_post_route");
/*
...
function registerDataStreamRoutes(dependencies) {
  ...
  (0, _register_post_route.registerPostOneApplyLatestMappings)(dependencies);
  (0, _register_post_route.registerPostOneRollover)(dependencies);
