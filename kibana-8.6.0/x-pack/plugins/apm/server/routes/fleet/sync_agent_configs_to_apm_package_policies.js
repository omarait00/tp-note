...
async function syncAgentConfigsToApmPackagePolicies({
  ...
  const [savedObjectsClient, agentConfigurations, packagePolicies] = await Promise.all([(0, _get_internal_saved_objects_client.getInternalSavedObjectsClient)(core.setup), (0, _list_configurations.listConfigurations)(internalESClient), (0, _get_apm_package_policies.getApmPackagePolicies)({
    core,
    fleetPluginStart
  })]);
