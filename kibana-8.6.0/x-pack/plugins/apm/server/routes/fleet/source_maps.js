    ...
    inputs: [{
      ...
      config: {
        ...
        [_register_fleet_policy_callbacks.APM_SERVER]: {
          value: {
            ...(firstInput === null || firstInput === void 0 ? void 0 : (_firstInput$config = firstInput.config) === null || _firstInput$config === void 0 ? void 0 : _firstInput$config[_register_fleet_policy_callbacks.APM_SERVER].value),
            rum: {
              source_mapping: {
