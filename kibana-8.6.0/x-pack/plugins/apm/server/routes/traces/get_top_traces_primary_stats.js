  ...
  return (0, _with_apm_span.withApmSpan)('get_top_traces_primary_stats', async () => {
    ...
    const response = await apmEventClient.search('get_transaction_group_stats', {
      ...
      body: {
        ...
        query: {
          bool: {
            filter: [...(0, _server.termQuery)(_elasticsearch_fieldnames.TRANSACTION_NAME, transactionName), ...(0, _transactions.getDocumentTypeFilterForTransactions)(searchAggregatedTransactions), ...(0, _server.rangeQuery)(start, end), ...(0, _environment_query.environmentQuery)(environment), ...(0, _server.kqlQuery)(kuery), (0, _transactions.isRootTransaction)(searchAggregatedTransactions)]
          }
        },
        aggs: {
          sample: {
