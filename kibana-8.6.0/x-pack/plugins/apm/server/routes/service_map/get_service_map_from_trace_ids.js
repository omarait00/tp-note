...
async function getServiceMapFromTraceIds({
  ...
  const serviceMapFromTraceIdsScriptResponse = await (0, _fetch_service_paths_from_trace_ids.fetchServicePathsFromTraceIds)(apmEventClient, traceIds, start, end);
