...
exports.calculateFailedTransactionRateFromServiceMetrics = calculateFailedTransactionRateFromServiceMetrics;
...
function calculateFailedTransactionRateFromServiceMetrics({
  failedTransactions,
  successfulTransactions
}) {
  var _successfulTransactio;
  if ((0, _lodash.isNull)(failedTransactions) || failedTransactions === 0) {
    return 0;
  }
  successfulTransactions = (_successfulTransactio = successfulTransactions) !== null && _successfulTransactio !== void 0 ? _successfulTransactio : 0;
  return failedTransactions / (successfulTransactions + failedTransactions);
}
