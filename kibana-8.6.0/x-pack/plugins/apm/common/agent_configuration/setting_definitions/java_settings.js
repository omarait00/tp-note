...

{
  ...
  type: 'text',
  defaultValue: '',
  label: _i18n.i18n.translate('xpack.apm.agentConfig.ignoreExceptions.label', {
    defaultMessage: 'Ignore exceptions'
  }),
  description: _i18n.i18n.translate('xpack.apm.agentConfig.ignoreExceptions.description', {
    defaultMessage: 'A list of exceptions that should be ignored and not reported as errors.\n' + 'This allows to ignore exceptions thrown in regular control flow that are not actual errors.'
  }),
  includeAgents: ['java']
}, {
  key: 'trace_methods',
  ...
  type: 'text',
  defaultValue: '',
  label: _i18n.i18n.translate('xpack.apm.agentConfig.unnestExceptions.label', {
    defaultMessage: 'Unnest exceptions'
  }),
  description: _i18n.i18n.translate('xpack.apm.agentConfig.unnestExceptions.description', {
    defaultMessage: 'When reporting exceptions,\n' + 'un-nests the exceptions matching the wildcard pattern.\n' + "This can come in handy for Spring's `org.springframework.web.util.NestedServletException`,\n" + 'for example.'
  }),
  includeAgents: ['java']
}];
