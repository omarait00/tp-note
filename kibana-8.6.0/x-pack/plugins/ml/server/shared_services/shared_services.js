...
var _trained_models = require("./providers/trained_models");
...
function createSharedServices(mlLicense, getSpaces, cloud, authorization, resolveMlCapabilities, getClusterClient, getInternalSavedObjectsClient, getUiSettings, getFieldsFormat, getDataViews, isMlReady) {
  ...
  return {
    ...
    sharedServicesProviders: {
      ...(0, _job_service.getJobServiceProvider)(getGuards),
      ...
      ...(0, _trained_models.getTrainedModelsProvider)(getGuards)
    },
    /**
     * Services providers for ML internal usage
     */
    internalServicesProviders: {
      ...(0, _jobs_health_service.getJobsHealthServiceProvider)(getGuards)
    }
  };
}
