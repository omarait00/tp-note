...
const modelSpecs = [_point_series.pointseries, _math.math, _tagcloud.tagcloud, _metric_vis.metricVis, _heatmap_legend.heatmapLegend, _heatmap_grid.heatmapGrid, _partition_labels.partitionLabels];
