...
var _map_to_columns = require("./map_to_columns");
Object.keys(_map_to_columns).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _map_to_columns[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _map_to_columns[key];
    }
  });
});
