...
const CSV_SEARCHSOURCE_IMMEDIATE_TYPE = 'csv_searchsource_immediate';
...
const DEPRECATED_JOB_TYPES = [CSV_JOB_TYPE_DEPRECATED];
...
const REPORT_TABLE_ROW_ID = 'reportJobRow';
