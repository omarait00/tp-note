...
var _unsecured_actions_client = require("./unsecured_actions_client/unsecured_actions_client.mock");
/*
...
const createStartMock = () => {
  const mock = {
    ...
    getUnsecuredActionsClient: jest.fn().mockReturnValue(_unsecured_actions_client.unsecuredActionsClientMock.create()),
