  ...
  monitoringCollection.registerMetric({
    ...
    fetch: async () => {
      try {
        ...
        const results = await pluginStart.taskManager.aggregate((0, _server.aggregateTaskOverduePercentilesForType)('actions'));
        ...
        return _types.EMPTY_CLUSTER_ACTIONS_METRICS;
      }
    }
  });
}