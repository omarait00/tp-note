...
async function getExecutionsPerDayCount(esClient, eventLogIndex, logger) {
  ...
  try {
    ...
    // @ts-expect-error aggegation type is not specified
    const aggsExecutions = (_actionResults$aggreg2 = actionResults.aggregations.totalExecutions) === null || _actionResults$aggreg2 === void 0 ? void 0 : _actionResults$aggreg2.byConnectorTypeId.value;
