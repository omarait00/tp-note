...
exports.podSnapshotMetricTypes = exports.metrics = void 0;
...
const podSnapshotMetrics = {
  cpu: _cpu.cpu,
  memory: _memory.memory,
  rx: _rx.rx,
  tx: _tx.tx
};
const podSnapshotMetricTypes = Object.keys(podSnapshotMetrics);
exports.podSnapshotMetricTypes = podSnapshotMetricTypes;
const metrics = {
  tsvb: {
