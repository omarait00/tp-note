...
const ESMaxPeriodFilterExistsAggRT = rt.type({
  filter: rt.type({
    exists: rt.type({
      field: rt.string
    })
...
exports.ESMaxPeriodFilterExistsAggRT = ESMaxPeriodFilterExistsAggRT;
...
const ESAggregationRT = rt.union([ESBasicMetricAggRT, ESPercentileAggRT, ESBucketScriptAggRT, ESCumulativeSumAggRT, ESDerivativeAggRT, ESSumBucketAggRT, ESTermsWithAggregationRT, ESCaridnalityAggRT, ESTopMetricsAggRT, ESMaxPeriodFilterExistsAggRT]);
