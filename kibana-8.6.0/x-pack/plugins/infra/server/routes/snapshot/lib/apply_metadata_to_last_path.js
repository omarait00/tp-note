...
const applyMetadataToLastPath = (series, node, snapshotRequest, source) => {
  ...
  if (rowWithMeta) {
    ...
    if (firstMetaDoc && lastPath) {
      ...
      lastPath.label = (_firstMetaDoc$invento = firstMetaDoc[inventoryFields.name]) !== null && _firstMetaDoc$invento !== void 0 ? _firstMetaDoc$invento : lastPath.value;
      ...
      if (inventoryFields.os) {
        lastPath.os = (0, _lodash.get)(firstMetaDoc, inventoryFields.os);
      }
