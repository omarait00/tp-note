...
class LogEntriesService {
  setup(core, setupDeps) {
    core.getStartServices().then(([, startDeps, selfStartDeps]) => {
      setupDeps.data.search.registerSearchStrategy(_log_entries.LOG_ENTRIES_SEARCH_STRATEGY, (0, _log_entries_search_strategy.logEntriesSearchStrategyProvider)({
        ...setupDeps,
        ...startDeps,
        ...selfStartDeps
      }));
      setupDeps.data.search.registerSearchStrategy(_log_entry.LOG_ENTRY_SEARCH_STRATEGY, (0, _log_entry_search_strategy.logEntrySearchStrategyProvider)({
        ...setupDeps,
        ...startDeps,
        ...selfStartDeps
      }));
