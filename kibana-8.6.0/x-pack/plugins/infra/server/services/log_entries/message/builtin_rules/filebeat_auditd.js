...
const filebeatAuditdRules = [{
  ...
  format: [...commonActionField, ...commonOutcomeField, ...(0, _helpers.labelFieldsPrefix)('user', 'user'), ...(0, _helpers.labelFieldsPrefix)('process', 'process'), {
    constant: ' '
  }, {
  ...
  when: {
    all: [{
      exists: ['ecs.version', 'event.action']
    }, {
      existsPrefix: ['auditd.log']
    }]
  },
  format: [...commonActionField, ...(0, _helpers.labelFieldsPrefix)('user', 'user'), ...(0, _helpers.labelFieldsPrefix)('process', 'process'), {
    constant: ' '
  }, {
    fieldsPrefix: 'auditd.log'
  }, {
