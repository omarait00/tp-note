...
exports.rewriteRuleLastRun = exports.rewriteRule = void 0;
...
const rewriteRuleLastRun = lastRun => {
  const {
    outcomeMsg,
    alertsCount,
    ...rest
...
exports.rewriteRuleLastRun = rewriteRuleLastRun;
const rewriteRule = ({
  alertTypeId,
  createdBy,
  updatedBy,
  ...
  ...(lastRun ? {
    last_run: rewriteRuleLastRun(lastRun)
  } : {}),
  ...(nextRun ? {
    next_run: nextRun
  } : {})
