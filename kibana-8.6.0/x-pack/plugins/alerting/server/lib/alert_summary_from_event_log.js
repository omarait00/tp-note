...
function alertSummaryFromEventLog(params) {
  var _rule$throttle, _event$kibana3, _event$kibana3$alerti;
  ...
  for (const event of events.reverse()) {
    var _event$event, _event$event2, _event$kibana, _event$kibana$alertin, _event$kibana2, _event$kibana2$alert;
    ...
    if (event !== null && event !== void 0 && (_event$kibana2 = event.kibana) !== null && _event$kibana2 !== void 0 && (_event$kibana2$alert = _event$kibana2.alert) !== null && _event$kibana2$alert !== void 0 && _event$kibana2$alert.flapping) {
    ...
    switch (action) {
      ...
      case _plugin.EVENT_LOG_ACTIONS.activeInstance:
        ...
        status.actionGroupId = event === null || event === void 0 ? void 0 : (_event$kibana3 = event.kibana) === null || _event$kibana3 === void 0 ? void 0 : (_event$kibana3$alerti = _event$kibana3.alerting) === null || _event$kibana3$alerti === void 0 ? void 0 : _event$kibana3$alerti.action_group_id;
        break;
