...
const initRoutes = (router, config) => {
  ...
  (0, _.readPrivilegesRoute)(router);
  (0, _.findListsBySizeRoute)(router);
  ...
  (0, _.findListItemRoute)(router);

  // indexes of lists
  (0, _.createListIndexRoute)(router);
  (0, _.readListIndexRoute)(router);
  (0, _.deleteListIndexRoute)(router);

  // exceptions import/export
  (0, _.exportExceptionsRoute)(router);
  (0, _.importExceptionsRoute)(router, config);
  ...
  (0, _.findExceptionListItemRoute)(router);

  // exception filter
  (0, _.getExceptionFilterRoute)(router);

  // endpoint list
  (0, _.createEndpointListRoute)(router);
  ...
  (0, _.summaryExceptionListRoute)(router);

  // internal routes
  (0, _.internalCreateExceptionListRoute)(router);
};
