...
const metricSet = [{
  ...
  name: 'kibana_os_load'
}, 'kibana_average_concurrent_connections', 'kibana_process_delay', {
...
}, 'kibana_instance_rule_failures', 'kibana_instance_rule_executions', 'kibana_instance_action_failures', 'kibana_instance_action_executions'];
