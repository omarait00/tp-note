...
var _download_sources = require("./download_sources");
Object.keys(_download_sources).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _download_sources[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _download_sources[key];
    }
  });
});
