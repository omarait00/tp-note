...
exports.PreconfiguredPackagesSchema = exports.PreconfiguredOutputsSchema = exports.PreconfiguredFleetServerHostsSchema = exports.PreconfiguredAgentPoliciesSchema = void 0;
...
const PreconfiguredFleetServerHostsSchema = _configSchema.schema.arrayOf(_configSchema.schema.object({
  id: _configSchema.schema.string(),
  name: _configSchema.schema.string(),
...
exports.PreconfiguredFleetServerHostsSchema = PreconfiguredFleetServerHostsSchema;
const PreconfiguredAgentPoliciesSchema = _configSchema.schema.arrayOf(_configSchema.schema.object({
  ..._agent_policy.AgentPolicyBaseSchema,
