...
const validatePackagePolicy = (packagePolicy, packageInfo, safeLoadYaml) => {
  ...
  if (!packageInfo.policy_templates || packageInfo.policy_templates.length === 0 || !packageInfo.policy_templates.find(policyTemplate => (0, _.isInputOnlyPolicyTemplate)(policyTemplate) || policyTemplate.inputs && policyTemplate.inputs.length > 0)) {
