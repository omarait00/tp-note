...
Object.keys(_user_profiles).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _user_profiles[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
...
Object.keys(_assignee).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _assignee[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
