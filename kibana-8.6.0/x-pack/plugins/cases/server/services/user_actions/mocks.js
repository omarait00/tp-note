...
exports.updatedTagsCases = exports.updatedCases = exports.updatedAssigneesCases = exports.originalCasesWithAssignee = exports.originalCases = exports.externalService = exports.comment = exports.casePayload = exports.attachments = void 0;
...
exports.originalCasesWithAssignee = originalCasesWithAssignee;
const updatedAssigneesCases = [{
  ...(0, _test_utils.createCaseSavedObjectResponse)(),
  id: '1',
  attributes: {
    assignees: [{
...
exports.updatedAssigneesCases = updatedAssigneesCases;
const updatedTagsCases = [{
  ...(0, _test_utils.createCaseSavedObjectResponse)(),
  id: '1',
  attributes: {
    tags: ['a', 'b']
...
exports.updatedTagsCases = updatedTagsCases;
const comment = {
  comment: 'a comment',
